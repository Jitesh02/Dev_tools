...
const XmlFormatter = () => {
    ...
    return (
        <div className="p-6 h-auto bg-gradient-to-br from-gray-100 to-white">
            <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">📝 XML Formatter</h1>

            <div className="flex items-center flex-col md:flex-row gap-">
                {/* Left Side: Input */}
                <div className="w-full md:w-1/2 space-y-4">
                    <label className="block text-gray-700 font-semibold">Unformatted XML</label>
                    <textarea
                        ...
                        placeholder="Paste or write your raw XML here..."
                        value={input}
                ...
                <div className="w-full md:w-1/2 space-y-2">
                    <label className="block text-gray-700 font-semibold">Formatted XML</label>
